...
public class Facade {
    ...
    // --- MÉTODOS DE SERVIÇO ---
    public void create(Servico s) throws SQLException{ this.rServico.create(s); }
    public void update(Servico s) throws SQLException{ this.rServico.update(s); }
    public Servico readServico(int codigo) throws SQLException{ return this.rServico.read(codigo); }
    public void deleteServico(int codigo) throws SQLException{ this.rServico.delete(codigo); }
    public List<Servico> readAllServico() throws SQLException{ return this.rServico.readAll(); }

    // --- MÉTODOS DE FUGITIVO ---
    public void create(Fugitivo f) throws SQLException{ this.rFugitivo.create(f); }
    public void update(Fugitivo f) throws SQLException{ this.rFugitivo.update(f); }
    public Fugitivo readFugitivo(int codigo) throws SQLException{ return this.rFugitivo.read(codigo); }
    ...
    public void create(Hospedeiro h) throws SQLException{ this.rHospedeiro.create(h); }
    ...
    public void create(Hospedagem h) throws SQLException{ this.rHospedagem.create(h); }
    public Hospedagem readHospedagem(int codigo) throws SQLException{ return this.rHospedagem.read(codigo); }
    ...
    public void create(Interesse i) throws SQLException { this.rInteresse.create(i); }
    ...
    // Este método chama o Repository (Caminho correto)
    ...
    // --- LÓGICA DE ACEITE (O PONTO CHAVE) ---
    // Remova as duplicadas e deixe apenas esta versão:
public void aceitarFugitivoNaHospedagem(int hospId, int fugitivoId) throws SQLException {
    // 1. Ocupa a vaga no banco (Chama o HospedagemRepository)
    ...
    // Usamos a conexão atual para garantir que ambos os UPDATES aconteçam
